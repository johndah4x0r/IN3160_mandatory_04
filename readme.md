...
* Create an .png or .pdf image of the waveform of the simulation result. Make sure a sensible amount of data is visible in the image. 
...
> * An image file of the simulation waveform for the 8 bit shiftregister. 
